...
if __name__ == "__main__":
    ...
    parser.add_argument('--image_dir',type = str,default=r'D:\Data\caption\ai_challenger\ai_challenger_caption_validation_20170910\caption_val_resize')
    parser.add_argument('--image_caption',type = str,default=
    r'D:\Data\caption\ai_challenger\ai_challenger_caption_validation_20170910\caption_validation_annotations_20170910.json')
    parser.add_argument('--encoder_path',type = str,default='./models/encoder-6-8200.pkl')
    parser.add_argument('--decoder_path',type=str,default='./models/decoder-6-8200.pkl')
    parser.add_argument('--val_index',type=str,default='6-8200')
